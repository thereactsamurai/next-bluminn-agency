      ...
      <section className="px-4 lg:px-0 container text-white">
        <section className="min-h-screen flex flex-col items-center justify-center gap-12 lg:items-start">
          <section className="text-center lg:text-left">
            <h2 className="mb-1 text-lg font-semibold uppercase tracking-widest md:mb-5 md:text-xl">
              Welcome to <Logo />
            </h2>
            <h1 className="max-w-3xl font-bold text-3xl leading-normal md:text-4xl lg:text-5xl xl:text-6xl md:leading-normal lg:leading-snug xl:leading-tight">
